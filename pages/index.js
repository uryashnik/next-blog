...
const Home = ({posts, categories}) => (
    <div>
        <div
            className='flex flex-col md:flex-row pb-9 md:pb-16 border-b border-primary border-opacity-10 dark:border-dividerDark'>
            ...
            <div className='shrink-0 w-full md:w-60 xl:w-80'>
                <div
                    className='flex items-center justify-between pb-5 border-b border-dashed border-primary border-opacity-10 dark:border-dividerDark'>
